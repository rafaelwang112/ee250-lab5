...
def main():
    ...
    for distance in distances:
        data = []
        tcp_data = pd.read_csv("iperf_tcp_" + str(distance) +"m.csv") #read tcp and udp files for given distance
        ...
        #plotting both TCP and UDP throughput on same set of axis
        ...
        fig.write_image("throughputs_graph_" + str(distance) + "m.png")#write to file
